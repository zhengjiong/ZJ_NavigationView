...
/**
 * 讓NavigationView覆蓋在Toolbar上面
 *
 * create by zhengjiong
 * Date: 2015-06-07
 * Time: 10:59
 */
public class NavigationViewOnToolbarDemo extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_view_on_toolbar_demo);
    ...
    private void initToolBar() {
        mToolbar.setTitle("NavigationViewOnToolbarDemo");
