 ...
 * Time: 10:59
 */
public class NavigationViewBasicDemo extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_view_basic_demo);
    ...
    private void initToolBar() {
        mToolbar.setTitle("NavigationViewBasicDemo");
